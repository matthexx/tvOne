...
public class MainFragment extends BrowseFragment {
    ...
    private void loadRows() {
        ...
        HeaderItem title = new HeaderItem(i, "Title");


        VerticalGridPresenter mGridPresenter = new VerticalGridPresenter();
    ...
    private void setupUIElements() {
        ...
        setSearchAffordanceColor(ContextCompat.getColor(getContext(), R.color.primary));
    }
